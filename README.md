...
El proyecto está dirigido a posibles clientes, que disfrutan de la buena lectura con una taza de café en la mano. El usuario podrá desplazarse por la página haciendo uso de enlaces a las diferentes secciones disponibles, en las cuales encontrará videos donde podrá aprender a preparar café con diferentes métodos y equipos. También tendrá la facilidad de hacer una reservación y asistir al establecimiento con la tranquilidad de que su espacio está asegurado. Tendrá disponible, además, los links a las redes sociales del establecimiento para interactuar y conocer las opiniones de otros clientes.
